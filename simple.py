...
class Simple(commands.Cog):
	...
	@cog_ext.cog_slash(name = "chut", description = "Permet de rappeller aux utilisateurs de ne pas discuter dans les salons d'enchères.")
