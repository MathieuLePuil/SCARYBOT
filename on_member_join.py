...
class On_member_join(commands.Cog):
    ...
    async def on_member_join(self, member):
        ...
        em = discord.Embed(title = "𝑵𝒐𝒖𝒗𝒆𝒂𝒖 𝒎𝒆𝒎𝒃𝒓𝒆", description = f"> **Bienvenue à toi** {member.mention} sur le **𝓢𝓬𝓪𝓻𝔂𝓼𝓱𝓸𝓹**. Tu es le **{member.guild.member_count} ème**. Je t'invite à lire le <#705101956418633848> pour ne pas te faire punir. Pour commander, rend-toi dans <#705135137830207568> et suis les instructions. \n \n *Bon jeu à toi sur le serveur !*", color = 0xFFA500)
