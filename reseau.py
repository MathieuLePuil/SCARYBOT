...
class Reseau(commands.Cog):
  ...
  async def reseau(self, ctx): 
    ...
    await ctx.send(embed = embed, components=[[Button(style=ButtonStyle.URL, label = "Instragam", url = "https://bit.ly/3tY8gUd", custom_id = "insta"), Button(style=ButtonStyle.URL, label = "Twitter", url = "https://bit.ly/3dIywMo", custom_id = "twitter"), Button(style=ButtonStyle.URL, label = "Youtube", url = "https://bit.ly/3aAeqSG", custom_id = "twitter")]])
