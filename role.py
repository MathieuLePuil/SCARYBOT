...
class Role(commands.Cog):
    ...
    async def tempgrade(self, ctx, user: discord.Member, duree, value):
        ...
        if value == "sorciere":
            em1 = discord.Embed(
                description=f"Le rôle <@&835561129186295858> a bien été ajouté à {user.mention} pour {duree} !",
                color=0xFF7F00)
            em1.set_footer(text="ScaryBot - Grades",
                           icon_url="https://cdn.discordapp.com/emojis/834364622555054080.png?size=128")
            em2 = discord.Embed(description=f"Le rôle <@&835561129186295858> a été retiré à {user.mention} !",
                                color=0xFF7F00)
            em2.set_footer(text="ScaryBot - Grades",
                           icon_url="https://cdn.discordapp.com/emojis/834364622555054080.png?size=128")
        ...
        if value == "faucheuse":
            em1 = discord.Embed(
                description=f"Le rôle <@&769261725421535244> a bien été ajouté à {user.mention} pour {duree} !",
                color=0xFF7F00)
            em1.set_footer(text="ScaryBot - Grades",
                           icon_url="https://cdn.discordapp.com/emojis/834364622555054080.png?size=128")
            em2 = discord.Embed(description=f"Le rôle <@&769261725421535244> a été retiré à {user.mention} !",
                                color=0xFF7F00)
            em2.set_footer(text="ScaryBot - Grades",
                           icon_url="https://cdn.discordapp.com/emojis/834364622555054080.png?size=128")
        ...
        if value == "fantome":
            em1 = discord.Embed(
                description=f"Le rôle <@&769261964311789588> a bien été ajouté à {user.mention} pour {duree} !",
                color=0xFF7F00)
            em1.set_footer(text="ScaryBot - Grades",
                           icon_url="https://cdn.discordapp.com/emojis/834364622555054080.png?size=128")
            em2 = discord.Embed(description=f"Le rôle <@&769261964311789588> a été retiré à {user.mention} !",
                                color=0xFF7F00)
            em2.set_footer(text="ScaryBot - Grades",
                           icon_url="https://cdn.discordapp.com/emojis/834364622555054080.png?size=128")
        ...
        if value == "assassin":
            em1 = discord.Embed(
                description=f"Le rôle <@&769262090308943935> a bien été ajouté à {user.mention} pour {duree} !",
                color=0xFF7F00)
            em1.set_footer(text="ScaryBot - Grades",
                           icon_url="https://cdn.discordapp.com/emojis/834364622555054080.png?size=128")
            em2 = discord.Embed(description=f"Le rôle <@&769262090308943935> a été retiré à {user.mention} !",
                                color=0xFF7F00)
            em2.set_footer(text="ScaryBot - Grades",
                           icon_url="https://cdn.discordapp.com/emojis/834364622555054080.png?size=128")
